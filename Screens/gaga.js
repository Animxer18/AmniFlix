...
const Gaga = ({ navigation, route }) => {
 ...
 const [gogoload,setgogoload ] =useState(true)
  ...
  const imageurls = [
    ...
    "https://media.tenor.com/bhh8ONgUSjYAAAAi/anime.gif",
    "https://media.tenor.com/Rlny2H_ioyAAAAAi/meltlilith-fate-series.gif",
    "https://media.tenor.com/Fo2g7NgHs_EAAAAi/anime.gif",
    "https://media.tenor.com/JlPZldv5YBQAAAAi/lordzebax.gif",
    "https://media.tenor.com/onfz4T81HIUAAAAi/bronya-zaychik-honkai.gif",
    "https://tenor.com/view/anime-gif-26108654",
    "https://media.tenor.com/3i--UTlTQvIAAAAi/hasher-happy-sticker.gif",
    "https://media.tenor.com/bBGOaRPgtvQAAAAi/good-menhera.gif",
    "https://media.tenor.com/D3WnFkAppYMAAAAi/alice-sticker-alice-animated.gif",
  ];
      ...
      <View style={{ backgroundColor: "#181a20" }}>
        ...
        <ScrollView>
          {gogoload ? (
            ...
            <View style={{ marginBottom: 100, marginTop: height * 0.03 }}>
              <FlatList
